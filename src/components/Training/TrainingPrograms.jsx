      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 lg:gap-6">
          {programs.map((item, index) => (
            <div
              key={index}
              className="group relative overflow-hidden rounded-2xl lg:rounded-3xl bg-white p-5 lg:p-6 border border-gray-100 transition-all duration-500 hover:-translate-y-2 hover:border-[#0EA5E9] hover:shadow-[0_20px_50px_rgba(14,165,233,0.25)]"
            >
              {/* Top Border */}
              ...
              {/* Icon */}
              <div className="relative z-10 w-12 h-12 lg:w-14 lg:h-14 rounded-xl lg:rounded-2xl bg-[#08172F] text-white flex items-center justify-center shadow-lg mb-5 group-hover:rotate-6 group-hover:scale-110 transition-all duration-500">
                {item.icon}
              </div>
        ...
        <div data-aos="fade-up" className="mt-14 lg:mt-20 text-center px-4">
          ...
          <a
            href="https://wa.me/919876543210?text=Hello%20BK%20STARGUARD%20SECURITY%20%26%20MANPOWER%20SERVICES,%20I%20want%20to%20apply%20for%20the%20Security%20Training%20Program."
            target="_blank"
