    ...
    <section className="relative py-10 md:py-16 bg-gradient-to-br from-[#F8FAFC] via-[#FDFCF9] to-[#F5F7FA] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div data-aos="fade-up" className="mt-14 lg:mt-20 text-center px-4">
          ...
          <a
            href="https://wa.me/918668317591?text=Hello%20BK%20STARGUARD%20SECURITY%20%26%20MANPOWER%20SERVICES,%20I%20want%20to%20apply%20for%20the%20Security%20Training%20Program."
            target="_blank"
